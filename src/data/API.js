export const BOOKS_API_URL = 'https://example-data.draftbit.com/books?_limit=50';
export const CARS_API_URL = 'https://example-data.draftbit.com/cars?_limit=50';
export const ACTIVISTS_API_URL = 'https://example-data.draftbit.com/activists?_limit=50';
